...
from kd2 import KDTree, KDNode, HORIZONTAL, VERTICAL
from arraySelect import selectKth
from region import X,Y,maxRegion
...
def generateSubTree(d, maxD, points, left, right):
    ...
    # update array [left,right] so mth element will be the median and
    ...
    # recursively compute below and above sub-trees
